...
C                                                                       
C THIS SUBROUTINE DECODES DATA CARDS FOR THE FB EXCITER AND             
...
C                                                                       
C STORE FB EXCITER DATA INTO CITER TABLE                                
C                                                                       
C  RC                                                                   
...
C  TE                                                                   
          ...
          return                                                        
C                                                                       
C DECODE DATA FOR FB EXCITER FROM FZ CARD                               
...
C                                                                       
C STORE FB EXCITER DATA FROM FZ CARD                                    
          return                                                        
          end                                                           
