C    %W% %G%
      subroutine pieqix (brnch,gk1,bk1,gk2,bk2,g12,b12,g21,b21)         
C ***                                                                   
...
C *** (RLTYPE,LTYPE)                                                    
C *** PIEQIX IS CALLED BY BRNCHY AND GETYEQ. IT IS IDENTICAL TO         
C *** SUBROUTNE PIEQIV EXCEPT FOR ONE COMMON BLOCK                      
C ***                                                                   
