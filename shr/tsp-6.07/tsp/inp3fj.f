...
C                                                                       
C THIS SUBROUTINE DECODES DATA CARDS FOR THE FJ EXCITER AND             
...
C                                                                       
C STORE FJ EXCITER DATA INTO CITER TABLE                                
C                                                                       
C  RC                                                                   
...
C  VRMIN                                                                
          ...
          return                                                        
C                                                                       
C DECODE DATA FOR FJ EXCITER FROM FZ CARD                               
...
1120   format(1h0,2x,a8,2x,f5.1,2x,a1,5x,'KF MUST BE GREATER THAN 0.0') 
       call prterr('E',1)                                               
       imchn = 3                                                        
          endif                                                         
       if(temp(6) .le.0.0) then                                         
       write(errbuf(1),1130)nbname,bkv,nid                              
1130   format(1h0,2x,a8,2x,f5.1,2x,a1,5x,'TF MUST BE GREATER THAN 0.0') 
       call prterr('E',1)                                               
       imchn = 3                                                        
          endif                                                         
 ...
 1140  format(1h0,2x,a8,2x,f5.1,2x,a1,5x,'EFDMAX MUST BE GREATER',      
     1 ' THAN 0.0')                                                     
       ...
       if(temp(3) .gt. temp(4)) then                                    
       write(errbuf(1),1150)nbname,bkv,nid                              
 1150  format(1h0,2x,a8,2x,f5.1,2x,a1,5x,'EFDMAX MUST BE GREATER THAN', 
     1' EFDMIN')                                                        
       call prterr('E',1)                                               
       imchn = 3                                                        
          endif                                                         
      if(imchn .gt. 0)return                                            
C                                                                       
C STORE FJ EXCITER DATA FROM FZ CARD                                    
C                                                                       
C  EFDMIN                                                               
          citer(5,isgg) = temp(3 )                                      
C  EFDMAX                                                               
...
C KC                                                                    
       citer(7,isgg) = citer(7,isgg)*bmvac                              
