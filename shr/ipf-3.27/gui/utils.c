static char sccsid[]="@(#)utils.c	20.17 9/9/98";
/*
...

int manage2parent(char *action, char *wname, char *wparent)
/********************************************************************\
* manage2parent
* author: Dan Clark
...
\********************************************************************/
{
  ...
  {
    case 'U':
      if((HashLookup(wname, &wid)) != False) XtUnmanageChild( wid );
    break;

    case 'M':		 /* otherwise process a manage request */
      ...
      if((HashLookup(wparent, &wpid)) == False)
      {
        ...
        if(wpid == FALSE ) return;
      }

      reparent( wname, wpid);	/* move "jacket" to a form */
   }
}
...
/****************************************************************************\
* Purpose: convert a MOTIF compound string to a char string
*
\****************************************************************************/
...

void change_cursor(char *cursor_fg, char *cursor_bg,
                   char *fg_color_name, char *bg_color_name,
                   int hotx, int hoty)
/*****************************************************************************\
*     Function:	Shortens code to change_cursor_to routine.
*
*     Note: Cursor bitmaps defined in ipfcursors.h
*
...
\*****************************************************************************/
{
  ...
  XLookupColor ( XtDisplay(w), color_map, fg_color_name,
    &xforecolor, &forecolor );

  XLookupColor ( XtDisplay(w), color_map, bg_color_name,
    &xbackcolor, &backcolor );

  background_bitmap = XCreateBitmapFromData ( XtDisplay(w), XtWindow(w),
    cursor_bg, 16, 16 );

  foreground_bitmap = XCreateBitmapFromData ( XtDisplay(w), XtWindow(w),
    cursor_fg, 16, 16 );

  the_cursor = XCreatePixmapCursor ( XtDisplay(w),
    foreground_bitmap, background_bitmap,
    &forecolor, &backcolor,
    hotx, hoty );

  XDefineCursor ( XtDisplay(w), XtWindow(w), the_cursor);
...
\*****************************************************************************/
{
  ...
  {
    case 0:  /* Input */
      change_cursor ( input_cursor_foreground, input_cursor_background,
        "black", "white",
        9, 7  /* hot spot */
      );
    break;
    ...
    case 1:  /* Output */
      change_cursor ( output_cursor_foreground, output_cursor_background,
        "black", "white",
        14, 7  /* hot spot */
      );
    break;
    ...
    case 2:  /* Input/output */
      change_cursor ( io_cursor_foreground, io_cursor_background,
        "black", "white",
        7, 7  /* hot spot */
      );
    break;
    ...
    case 3:  /* Star */
      change_cursor ( star_cursor_foreground, star_cursor_background,
        "black", "white",
        7, 7  /* hot spot */
      );
    break;
    ...
    case 4:  /* Delete */
      change_cursor ( del_cursor_foreground, del_cursor_background,
        "red", "white",
        8, 8  /* hot spot */
      );
    break;
    ...
    case 6:  /* Undelete */
      change_cursor ( undel_cursor_foreground, undel_cursor_background,
        "red", "white",
        7, 7  /* hot spot */
      );
    break;
    ...
    case 8:  /* New Bend */
      change_cursor ( move_cursor_foreground, move_cursor_background,
        "blue", "white",
        1, 1  /* hot spot */
      );
    break;
    ...
    case 10:  /* New bus */
      change_cursor ( bus_cursor_foreground, bus_cursor_background,
        "black", "white",
        8, 8  /* hot spot */
      );
    break;
    ...
    case 11:  /* New line */
      change_cursor ( line_cursor_foreground, line_cursor_background,
        "blue", "white",
        8, 8  /* hot spot */
      );
    break;
    ...
    case 12:  /* Draw */
      change_cursor ( draw_cursor_foreground, draw_cursor_background,
        "black", "white",
        8, 8  /* hot spot */
      );
    break;
    ...
    case 13:  /* Alpha */
      change_cursor ( alph_cursor_foreground, alph_cursor_background,
        "black", "white",
        8, 8  /* hot spot */
      );
    break;
    ...
    case 14:  /* Group */
      change_cursor ( grp_cursor_foreground, grp_cursor_background,
        "black", "white",
        8, 8  /* hot spot */
      );
    break;
    ...
    case 15:  /* Plot Dialog */
      change_cursor ( plot_cursor_foreground, plot_cursor_background,
        "black", "white",
        8, 8  /* hot spot */
      );
    break;
...

/***************************************************************************\
*  Purpose: left justify a text widget
*
