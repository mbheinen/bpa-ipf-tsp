...
{"updateVertexPosition", (caddr_t)updateVertexPosition},
 ...
 */
static char sccsid[] = "@(#)vuit_main_template_c	20.53 6/17/97";
main(int argc, char *argv[])
{
   ...
   getResources(&app_resdata, argc, argv);
    ...
    sprintf(main_window_title, "INTERACTIVE POWERFLOW GRAPHICAL USERS INTERFACE - Version JUN_18_97");
...
VUIT_Manage("help_menu_error_msg_pb");
