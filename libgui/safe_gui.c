...
void pfsolution_cb();
void get_cont_bus_rec();
void cancel_bus_branch_edit_dia();
...
{"setCurBusDefaultName", (caddr_t)setCurBusDefaultName},
...
{"get_cont_bus_rec", (caddr_t)get_cont_bus_rec},
{"cancel_bus_branch_edit_dia", (caddr_t)cancel_bus_branch_edit_dia},
...
{"help_annotate_close", (caddr_t)help_annotate_close},
...
{"dc_multi_term_rec", (caddr_t)dc_multi_term_rec},
...
{"graphBendToggleLabel", (caddr_t)graphBendToggleLabel},
...
{"system_test", (caddr_t)system_test},
 ...
 */
static char sccsid[] = "@(#)vuit_main_template_c	20.36 7/6/95";
main(int argc, char *argv[])
{
   ...
   getResources(&app_resdata, argc, argv);
    ...
    sprintf(main_window_title, "INTERACTIVE POWERFLOW GRAPHICAL USERS INTERFACE - Version JUL_17_95");
...
void get_cont_bus_rec(Widget w, XtPointer tag, XtPointer reason)
{
}
void cancel_bus_branch_edit_dia(Widget w, XtPointer tag, XtPointer reason)
{
VUIT_Unmanage("bus_branch_edit_dialog");
}
...
void help_annotate_close(Widget w, XtPointer tag, XtPointer reason)
{
}
...
void dc_multi_term_rec(Widget w, XtPointer tag, XtPointer reason)
{
HashRegister(XtName(w), w);
}
