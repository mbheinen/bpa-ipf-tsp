...
C                                                                       
C THIS SUBROUTINE DECODES DATA CARDS FOR THE FE EXCITER AND             
...
C                                                                       
 ...
 110      format(1h0,2x,a8,2x,f5.1,2x,a1,5x,'KV MUST BE GREATER THAN '  
     1       ,'0.0')                                                    
          call prterr('E',1)                                            
          imchn = 3                                                     
       endif                                                            
 ...
 120      format(1h0,2x,a8,2x,f5.1,2x,a1,5x,'TRH MUST BE GREATER THAN ' 
     1       ,'0.0')                                                    
          call prterr('E',1)                                            
          imchn = 3                                                     
       endif                                                            
...
C                                                                       
C STORE FE EXCITER DATA INTO CITER TABLE                                
C                                                                       
C  RC                                                                   
...
C  KV                                                                   
          citer( 8,isgg) = temp( 8)                                     
C  KV*TRH                                                               
          citer(25,isgg) = temp(8) * temp(9) * frqbse                   
C  VRMAX                                                                
          vrmax = temp(10)                                              
...
C  TE                                                                   
          ...
          return                                                        
C                                                                       
C DECODE DATA FOR FE EXCITER FROM FZ CARD                               
...
C                                                                       
          ...
          sd100 = temp(1)                                               
          sd75 = temp(2)                                                
          esat = (alog(sd100/sd75)) / (0.25*efd1)                       
...
C                                                                       
C STORE FE EXCITER DATA FROM FZ CARD                                    
          return                                                        
          end                                                           
