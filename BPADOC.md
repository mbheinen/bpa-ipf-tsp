...
Usage:  ipfplot <coordinatefile.cor> <basefile1.bse> <basefile2.bse(opt)> <cr>
...
Advanced Users Guide (ipfadv.pdf).
...
LOCATION: (Look here for the most recent updates.)
    BPA9::DISK24:[PSAP.IPF.CFPROGS]FINDOUT.EXE      - The VAX executable
    BPA9::DISK24:[PSAP.IPF.CFPROGS]FINDOUT.ALF_EXE  - The ALPHA executable
    BPA9::DISK24:[PSAP.IPF.CFPROGS]FINDOUT.C        - The C source code
    BPA9::DISK24:[PSAP.IPF.CFDOC]FINDOUT.HELP       - Text help file


BPA9::disk24:[psap.ipf.cfdoc]findout.help
 ...
 * Creating a new PTI Translation File
  ...
  Owner records: original     1 inserted     3
...
PATH USE FACTORS, Ver. 1.01:
Created: Friday, July 28, 2000 10:36 AM
Revised: Wednesday, November 8, 2000 1:30 PM/jgs
...
Usage:  puf [-x|] [-lossless] [-pv] [-ai] [-g] [-ps] [-p1] [-c <cutfile>]<cr>
	...
	where the parameters enclosed in square brackets [...] are optional. 
...
conjunction with -pv option.  The lossless formulation minimizes the affect
...
Example, using a single parameter:
...
L RAVER 500 PAUL 5001  put in a text file, flowgate.txt
...
LOCATION: (Look here for the most recent updates.)
    BPA9::DISK24:[PSAP.IPF.CFPROGS]PVCURVE_PRO.EXE        - The VAX executable
    BPA9::DISK24:[PSAP.IPF.CFPROGS]PVCURVE_PRO.ALF_EXE    - The ALPHA executable
    BPA9::DISK24:[PSAP.IPF.CFPROGS]PVCURVE_PRO.C          - The C source code
    BPA9::DISK24:[PSAP.IPF.CFDOC]PVCURVE_PRO.HELP         - This file


BPA9::disk24:[psap.ipf.cfdoc]PVCURVE_PRO.help
UTILITY:    PVcurve_pro - multiple buses perturbed in sequence
STRUCTURE:  common CFLOW architecture.
TYPE:       Powerflow (IPFSRV), /CHANGE_PARAMETER voltage-reactance curve.
SUMMARY:    Generate voltage reactance curves.
