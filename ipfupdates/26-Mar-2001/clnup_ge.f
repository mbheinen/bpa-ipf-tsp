...
c
            ...
            write (errbuf(1), 10000) pti_znum(i), pti_znam(num2),
     &        pti_znum(num2), pti_znam(num2), pti_znum(i),
     &        pti_znam(i)
      ...
      do i = 1, count
        ...
        if (num .eq. 0) then
          ...
          if (status .eq. 0) then
            ...
            write (errbuf(1), 10010) array(1,i), pti_znam(num)
     ...
     &              1x, a, ' renamed to ', i4, 1x, a)
      ...
      do nb = 1, ntot
        ...
        if (nptib .gt. 0) then
          ...
          if (nptiz .gt. 0) then
            p = find_hash (pti_znum(nptiz), pti_anum(nptia))
            p = iabs (p)
...
c     2. Sort branches 
c     3. Convert owner numbers to owner names
