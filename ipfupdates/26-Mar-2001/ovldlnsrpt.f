...
c                loaded above a prescribed load level.
c
...
C****************************************************************
C
	subroutine ovldlnsrpt (in_buf, out_buf, scrfil) 
...
C                                                                       
   ...
   90   format (' Transmission Line Loading - Case ', a, ' Date ', a)
        header(2) = ' Own Zn Bus1    Base Zn Bus2    Base IS Case ' //
     &              '--------------- Ratings ------------'
        header(3) = '                                             ' //
     &              'Thermal  Bottlnk  Nominal '
        header(4) = '                                        ' //
     &              'amps amps   % amps   % amps   %'
...
c***    do while (ix .le. ntot .and. o2 .le. maxbuf_out)
C***    do while (ix .le. ntot)
           nb = vltsrt(ix)                                           
     ...
     1                             buf(7:18), zone(k2), buf(20:31), 
     2                             buf(32:32), buf(33:33),
     3                             icaseld, iratthr, iovthr, iratbtl, 
     4                             iovbtl, iratnom, iovnom
